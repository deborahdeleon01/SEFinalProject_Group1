...
public final class DirectoryStructure {
    ...
    //Directory paths
    private static final String VACPAC_XML = "./XML/";
    private static final String VACPAC_CSS = "./STYLES/";
    private static final String VACPAC_PDF = "./PDF/";
    private static final String VACPAC_PDF_EMAIL = "./PDF/EmailAttachment/";
    private static final String VACPAC_HTML = "./HTML";
    private static final String VACPAC_ROOT = "";
